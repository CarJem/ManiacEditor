...
namespace ManiacEditor.Methods.Drawing
{
    public class TextureCreator
    {
        ...
        public static Classes.Rendering.TextureExt FromBitmap(Device device, Bitmap bitmap)
        {
            Classes.Rendering.TextureExt texture = new Classes.Rendering.TextureExt(device, bitmap.Width, bitmap.Height, 1, Usage.Dynamic, Format.A8R8G8B8, Pool.Default);
            DataStream data;
        ...
        public static Classes.Rendering.TextureExt FromBitmapChunk(Device device, Bitmap bitmap)
        {
            Classes.Rendering.TextureExt texture = new Classes.Rendering.TextureExt(device, 128, 128, 1, Usage.Dynamic, Format.A8R8G8B8, Pool.Default);
            DataStream data;
            DataRectangle rec = texture.LockRectangle(0, LockFlags.None, out data);
