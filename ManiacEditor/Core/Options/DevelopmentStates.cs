    ...
    public class DevelopmentStates
    {
        ...
        public static void Save()
        {
            try
            {
                ...
                File.WriteAllText(Constants.DevelopmentStatesFilePath, json);
            }
            catch (Exception ex)
            {
        ...
        public static void Reload()
        {
            try
            {
                if (!File.Exists(Constants.DevelopmentStatesFilePath)) File.Create(Constants.DevelopmentStatesFilePath).Close();
