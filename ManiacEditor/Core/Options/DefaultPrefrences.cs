    ...
    public class DefaultPrefrences
    {
        ...
        public static void Save()
        {
            try
            {
                ...
                File.WriteAllText(Constants.DefaultPrefrencesFilePath, json);
            }
            catch (Exception ex)
            {
        ...
        public static void Reload()
        {
            try
            {
                if (!File.Exists(Constants.DefaultPrefrencesFilePath)) File.Create(Constants.DefaultPrefrencesFilePath).Close();
