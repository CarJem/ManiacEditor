...
namespace ManiacEditor.Structures
{
    public struct EntityRenderProp
    {
        ...
        public EntityRenderProp(Classes.Editor.Draw.GraphicsHandler d, RSDKv5.SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, Methods.Entities.EntityAnimator Animation = null, bool selected = false)
        {
            Graphics = d;
            Object = entity;
            EditorObject = e;
