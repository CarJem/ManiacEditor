...
namespace ManiacEditor.Controls.Utility
{
    ...
    public partial class ExportAsImageGUI : Window
    {
        ...
        private void ExportButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                bool result = ManiacEditor.Methods.Solution.SolutionLoader.ExportAsPNG(ExtraLayersForExport);
                if (result != false) DialogResult = true;
            }
            else
            {
                bool result = ManiacEditor.Methods.Solution.SolutionLoader.ExportLayersAsPNG(ExtraLayersForExport);
                if (result != false) DialogResult = true;
            }
