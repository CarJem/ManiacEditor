...
namespace ManiacEditor.Controls.Utility.Editor.Configuration
{
    ...
    public partial class ModConfigEditor : Window
	{
		...
		public ModConfigEditor(bool edit = false, int editIndex = 0)
		{
			...
			if (edit == true)
			{
				richTextBox1.AppendText(Methods.Settings.MySettings.ModLoaderConfigs[editIndex]);
				textBox1.Text = Methods.Settings.MySettings.ModLoaderConfigsNames[editIndex];
