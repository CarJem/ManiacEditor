...
namespace ManiacEditor.Interfaces
{
	...
	{
		private Classes.Edit.Solution.EditorScene _editorScene;
		private IList<Classes.Edit.Solution.EditorLayer> Layers
		{
        ...
        private Classes.Edit.Solution.EditorLayer SelectedLayer;
		...
		//Clipboards
		private Classes.Edit.Solution.EditorLayer LayerClipboard;



		// I clearly have no understanding of WinForms Data Binding
		public LayerManager(Classes.Edit.Solution.EditorScene editorScene)
		{
			InitializeComponent();
		...
		{
			Classes.Edit.Solution.EditorLayer newEditorLayer = _editorScene.ProduceLayer();
		...
		private void CopyLayerToClipboard(Classes.Edit.Solution.EditorLayer layerToCopy)
		{
			Classes.Edit.Solution.EditorLayer copyData = layerToCopy;
		...
		public void PasteLayerFromClipboard()
		{
			...
			{
				var layerToPaste = (Classes.Edit.Solution.EditorLayer)Clipboard.GetDataObject().GetData("ManiacLayer");
