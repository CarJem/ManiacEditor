...
namespace ManiacEditor.Interfaces
{
    ...
    public partial class ObjectImporter : Window
    {
        ...
        public ObjectImporter(IList<SceneObject> sourceSceneObjects, IList<SceneObject> targetSceneObjects, StageConfig stageConfig, Interfaces.Base.MainEditor instance)
        {
            InitializeComponent();
        ...
        public ObjectImporter(string dataFolderBase, Gameconfig SourceConfig, IList<SceneObject> targetSceneObjects, StageConfig stageConfig, Interfaces.Base.MainEditor instance)
        {
            InitializeComponent();
            EditorInstance = instance;
            SetupWindow();
