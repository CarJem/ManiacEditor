...
namespace ManiacEditor
{
    ...
    public class EditorAnimations
    {
        ...
        {
            // Playback
            if (EditorInstance.ShowAnimations.IsChecked.Value && EditorInstance.Options.AllowSpriteAnimations)
            {
				if (speed > 0)
                {
        ...
        public void ProcessMovingPlatform(int angleDefault, UInt32 speed = 3)
        {
            ...
            int duration = 1;
            // Playback
            if (EditorInstance.ShowAnimations.IsChecked.Value && EditorInstance.Options.AllowMovingPlatformAnimations)
            {
				if (speed > 0)
                {
