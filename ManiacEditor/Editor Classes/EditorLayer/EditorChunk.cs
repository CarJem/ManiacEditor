...
namespace ManiacEditor
{
    public class EditorChunk
	{
		...
		public EditorChunk(Editor instance, StageTiles stageTiles, Stamps stageStamps)
		{
			...
			AddBlankMap();
			Tiles = Classes.Edit.Scene.EditorSolution.CurrentTiles.StageTiles;
		}
        ...
        public void AutoGenerateChunks(Classes.Edit.Scene.EditorSolution.EditorLayer LayerA)
        {
        ...
        public void AutoGenerateChunks(Classes.Edit.Scene.EditorSolution.EditorLayer LayerA, Classes.Edit.Scene.EditorSolution.EditorLayer LayerB)
        {
            EditorInstance.UI.UpdateWaitingScreen(true);
            EditorInstance.UI.ToggleEditorButtons(false);
		...
		public void PasteStamp(Point ChunkCoord, int index, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayerA, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayerB, bool deleteMode = false)
		{
        ...
        public bool DoesChunkMatch(Point point, Stamps.TileChunk CompareChunk, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayerA, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayerB, int chunkSize = 8)
        {
        ...
        public bool DoesChunkMatch(Point point, Stamps.TileChunk CompareChunk, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayer, int chunkSize = 8)
		{
			Point TileCoord = new Point(point.X * 128, point.Y * 128);
			for (int x = 0; x < chunkSize; x++)
			{
        ...
        public bool IsChunkEmpty(Point point, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayer, int chunkSize = 8)
		{
        ...
        public bool IsChunkEmpty(Point point, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayerA, Classes.Edit.Scene.EditorSolution.EditorLayer EditLayerB, int chunkSize = 8)
        {
