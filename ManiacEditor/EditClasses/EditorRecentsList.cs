...
namespace ManiacEditor
{
    public class EditorRecentSceneSourcesList
	{
        ...
        public SceneSaveStateCollection.SaveState GenerateNewEntry()
        {
            ...
            Name += EditClasses.EditorState.LevelID;
            ...
            int x1 = (short)(EditClasses.EditorState.ViewPositionX / EditClasses.EditorState.Zoom);
            int y1 = (short)(EditClasses.EditorState.ViewPositionY / EditClasses.EditorState.Zoom);
            ...
            section.x = x1;
            section.y = y1;
            section.ZoomLevel = EditClasses.EditorState.ZoomLevel;
            section.isEncore = Instance.Paths.isEncoreMode;
            section.LevelID = EditClasses.EditorState.LevelID;
