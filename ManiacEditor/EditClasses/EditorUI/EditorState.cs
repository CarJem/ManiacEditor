...
namespace ManiacEditor.EditClasses
{
    public class EditorState
    {
        ...
        {
            if (CurrentSolution.Entities != null && CurrentSolution.Entities.SetupObject != null && CurrentSolution.Entities.SetupObject != "")
            {
                return "Setup Object: " + CurrentSolution.Entities.SetupObject;
            }
            else
            {
        ...
        public static int TempRegionX1 { get; set; }
        public static int TempRegionX2 { get; set; }
        public static int TempRegionY1 { get; set; }
        public static int TempRegionY2 { get; set; }
        ...
        public static bool UseEncoreColors
        {
            ...
            set
            {
                ...
                CurrentSolution.CurrentTiles.StageTiles?.Image.Reload((value ? Editor.Instance.EncorePalette[0] : null));
