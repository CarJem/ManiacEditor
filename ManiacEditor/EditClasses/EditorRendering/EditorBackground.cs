...
namespace ManiacEditor
{
    class EditorBackground : IDrawable
    {
        ...
        public void Draw(DevicePanel d)
        {
            ...
            RSDKv5Color rcolor1 = CurrentSolution.CurrentScene.EditorMetadata.BackgroundColor1;
            RSDKv5Color rcolor2 = CurrentSolution.CurrentScene.EditorMetadata.BackgroundColor2;
        ...
        {
            int GridSize = (EditorInstance != null ? EditClasses.EditorState.GridSize : 0);
            Rectangle screen = d.GetScreen();

			Color GridColor = Color.FromArgb((int)EditorInstance.EditorToolbar.gridOpacitySlider.Value, EditClasses.EditorState.GridColor.R, EditClasses.EditorState.GridColor.B, EditClasses.EditorState.GridColor.G);
