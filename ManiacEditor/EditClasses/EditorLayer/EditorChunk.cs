...
namespace ManiacEditor
{
	public class EditorChunk
	{
		...
		public EditorChunk(Editor instance, StageTiles stageTiles, Stamps stageStamps)
		{
			...
			AddBlankMap();
			Tiles = CurrentSolution.CurrentTiles.StageTiles;
		}
        ...
        public void AutoGenerateChunks(ManiacEditor.EditClasses.Solution.EditorLayer LayerA)
        {
        ...
        public void AutoGenerateChunks(ManiacEditor.EditClasses.Solution.EditorLayer LayerA, ManiacEditor.EditClasses.Solution.EditorLayer LayerB)
        {
            EditorInstance.UI.UpdateWaitingScreen(true);
            EditorInstance.UI.ToggleEditorButtons(false);
		...
		public void PasteStamp(Point ChunkCoord, int index, ManiacEditor.EditClasses.Solution.EditorLayer EditLayerA, ManiacEditor.EditClasses.Solution.EditorLayer EditLayerB, bool deleteMode = false)
		{
        ...
        public bool DoesChunkMatch(Point point, Stamps.TileChunk CompareChunk, ManiacEditor.EditClasses.Solution.EditorLayer EditLayerA, ManiacEditor.EditClasses.Solution.EditorLayer EditLayerB, int chunkSize = 8)
        {
        ...
        public bool DoesChunkMatch(Point point, Stamps.TileChunk CompareChunk, ManiacEditor.EditClasses.Solution.EditorLayer EditLayer, int chunkSize = 8)
		{
			Point TileCoord = new Point(point.X * 128, point.Y * 128);
			for (int x = 0; x < chunkSize; x++)
			{
        ...
        public bool IsChunkEmpty(Point point, ManiacEditor.EditClasses.Solution.EditorLayer EditLayer, int chunkSize = 8)
		{
        ...
        public bool IsChunkEmpty(Point point, ManiacEditor.EditClasses.Solution.EditorLayer EditLayerA, ManiacEditor.EditClasses.Solution.EditorLayer EditLayerB, int chunkSize = 8)
        {
