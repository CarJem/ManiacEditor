...
using ManiacEditor.Interfaces.EditorElements;
...
namespace ManiacEditor.EditClasses.Solution
{
    public static class CurrentSolution
    {
        ...
        public static void UnloadScene()
        {
            ...
            EditorState.LevelID = -1;
            EditorState.EncorePaletteExists = false;
            EditorState.EncoreSetupType = 0;
            ...
            EditorState.QuitWithoutSavingWarningRequired = false;

            if (CurrentTiles != null) CurrentTiles.Dispose();
            CurrentTiles = null;
            ...
            EditorState.MenuChar = EditorState.MenuCharS.ToCharArray();
            EditorState.MenuChar_Small = EditorState.MenuCharS_Small.ToCharArray();
            EditorState.LevelSelectChar = EditorState.LevelSelectCharS.ToCharArray();
