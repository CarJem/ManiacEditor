...
namespace ManiacEditor
{
    public class EditorEntities : IDrawable
    {
        ...
        public string GetSetupObject(Scene scene)
        {
            try
            {
                var objectList = GetObjects(CurrentSolution.CurrentScene.Objects);
        ...
        private void DuplicateEntities(List<EditorEntity> entities)
        {
            ...
            foreach (var entity in entities)
            {
                ...
                if (entity.IsExternal())
                    sceneEntity = SceneEntity.FromExternal(entity.Entity, CurrentSolution.CurrentScene.Objects, slot);
        ...
        public void DrawInternalObjects(DevicePanel d)
        {
            ...
            foreach (var entity in InternalEntities)
            {
                ...
                if (entity.Name == "Spline")
                {
                    ...
                    if (!EditClasses.EditorState.SplineOptionsGroup.ContainsKey(id)) EditClasses.EditorState.AddSplineOptionsGroup(id);
            ...
            foreach (var path in SplineXPos)
            {
                ...
                EditClasses.EditorState.SplineOptions selectedOptions = EditClasses.EditorState.SplineOptionsGroup[splineID];
