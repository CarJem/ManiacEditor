...
namespace ManiacEditor
{
    public class EditorControl
    {
        ...
        {
            if (!Classes.Editor.SolutionState.Scrolling) Controls.Base.MainEditor.Instance.FormsModel.GraphicPanel.Focus();
        ...
        public void MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (Classes.Editor.SolutionState.Scrolling || Classes.Editor.SolutionState.ScrollingDragged || Classes.Editor.SolutionState.DraggingSelection || Classes.Editor.SolutionState.Dragged) Controls.Base.MainEditor.Instance.FormsModel.GraphicPanel.Render();
        ...
        public void InteractiveMouseMove(System.Windows.Forms.MouseEventArgs e)
        {
            ...
            {
                Controls.Base.MainEditor.Instance.InGame.MovePlayer(new Point(e.X, e.Y), Classes.Editor.SolutionState.Zoom, Controls.Base.MainEditor.Instance.InGame.SelectedPlayer);
            }
        ...
        public void ScrollerMouseMove(MouseEventArgs e)
        {
            ...
            double xMove = (Controls.Base.MainEditor.Instance.FormsModel.hScrollBar1.IsVisible) ? e.X - Classes.Editor.SolutionState.ViewPositionX - Classes.Editor.SolutionState.ScrollPosition.X : 0;
            double yMove = (Controls.Base.MainEditor.Instance.FormsModel.vScrollBar1.IsVisible) ? e.Y - Classes.Editor.SolutionState.ViewPositionY - Classes.Editor.SolutionState.ScrollPosition.Y : 0;
