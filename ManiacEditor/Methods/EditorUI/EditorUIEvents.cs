...
namespace ManiacEditor
{
    ...
    public class EditorUIEvents
	{
		...
		public EditorUIEvents(Interfaces.Base.MainEditor instance)
		{
			Editor = instance;
        ...
        public void ChangeLevelID(object sender, RoutedEventArgs e)
		{
			...
			Interfaces.Base.MainEditor.Instance.EditorStatusBar._levelIDLabel.Content = "Level ID: " + Classes.Editor.SolutionState.LevelID.ToString();
		}
		...
		public void FindAndReplaceTool(object sender, RoutedEventArgs e)
		{
			...
			if (form.DialogResult == true)
			{
				...
				if (replaceMode)
				{
					Interfaces.Base.MainEditor.Instance.FindAndReplace.EditorTileFindReplace(find, replace, applyState, copyResults);//, perserveColllision
				}
				else
				{
					Interfaces.Base.MainEditor.Instance.FindAndReplace.EditorTileFind(find, applyState, copyResults);
				}
