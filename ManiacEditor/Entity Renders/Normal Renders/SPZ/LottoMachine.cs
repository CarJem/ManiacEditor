...
namespace ManiacEditor.Entity_Renders
{
    public class LottoMachine : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnim2 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 1, fliph, flipv, false);
            var editorAnim3 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 2, fliph, flipv, false);
            var editorAnim4 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 3, fliph, flipv, false);
            var editorAnim5 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 4, fliph, flipv, false);
            var editorAnim3_2 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 2, true, flipv, false);
            var editorAnim4_2 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 3, true, flipv, false);
            var editorAnim5_2 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 4, true, flipv, false);
            var editorAnim6 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 5, fliph, flipv, false);
            var editorAnim7 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 6, fliph, flipv, false);
            var editorAnim8 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 7, fliph, flipv, false);
            var editorAnim9 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, fliph, flipv, false);
            var editorAnim10 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 9, fliph, flipv, false);
            var editorAnim11 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, true, false, false);
            var editorAnim12 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, true, true, false);
            var editorAnim13 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, false, true, false);
            var editorAnim14 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 1, fliph, flipv, false);
            var editorAnim15 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 2, fliph, flipv, false);
            var editorAnim16 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnim17 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 2, 0, fliph, flipv, false);
            var editorAnim18 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 1, fliph, flipv, false);
