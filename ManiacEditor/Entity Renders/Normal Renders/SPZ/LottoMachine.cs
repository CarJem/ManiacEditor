...
namespace ManiacEditor.Entity_Renders
{
    public class LottoMachine : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityRenderProp properties)
        {
            ...
            var editorAnim = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnim2 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 1, fliph, flipv, false);
            var editorAnim3 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 2, fliph, flipv, false);
            var editorAnim4 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 3, fliph, flipv, false);
            var editorAnim5 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 4, fliph, flipv, false);
            var editorAnim3_2 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 2, true, flipv, false);
            var editorAnim4_2 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 3, true, flipv, false);
            var editorAnim5_2 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 4, true, flipv, false);
            var editorAnim6 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 5, fliph, flipv, false);
            var editorAnim7 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 6, fliph, flipv, false);
            var editorAnim8 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 7, fliph, flipv, false);
            var editorAnim9 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, fliph, flipv, false);
            var editorAnim10 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 9, fliph, flipv, false);
            var editorAnim11 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, true, false, false);
            var editorAnim12 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, true, true, false);
            var editorAnim13 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 8, false, true, false);
            var editorAnim14 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 1, fliph, flipv, false);
            var editorAnim15 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 2, fliph, flipv, false);
            var editorAnim16 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnim17 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 2, 0, fliph, flipv, false);
            var editorAnim18 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("LottoMachine", d.DevicePanel, 0, 1, fliph, flipv, false);
...
frame13.Frame.Width, frame13.Frame.Height, false, Transparency);
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(ballslot1),
                ...
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(ballslot2),
                ...
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(ballslot3),
...
ballslot3.Frame.Width, ballslot3.Frame.Height, false, Transparency);
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(ballslot1_2),
...
ballslot1_2.Frame.Width, ballslot1_2.Frame.Height, false, Transparency);
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(ballslot2_2),
                ...
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(ballslot3_2),
...
ballslot3_2.Frame.Width, ballslot3_2.Frame.Height, false, Transparency);
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(galloplogo),
                ...
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(chute),
...
chute.Frame.Width, chute.Frame.Height, false, Transparency);
                d.DrawBitmap(new Classes.Editor.Draw.GraphicsHandler.GraphicsInfo(dispenser),
