...
namespace ManiacEditor.Entity_Renders
{
    public class PopcornMachine : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnim2 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 1, fliph, flipv, false);
            var editorAnim3 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 2, false, false, false);
            var editorAnim4 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 3, false, false, false);
            var editorAnim5 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 6, false, false, false);
            var editorAnim6 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 7, false, false, false);
            var editorAnim7 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 4, false, false, false);
            var editorAnim8 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 5, false, false, false);
            var editorAnim9 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 9, false, false, false);
            var editorAnim10 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("PopcornMachine", d.DevicePanel, 0, 10, false, false, false);
