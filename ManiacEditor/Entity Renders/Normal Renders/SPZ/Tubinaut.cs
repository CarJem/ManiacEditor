...
namespace ManiacEditor.Entity_Renders
{
    public class Tubinaut : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tubinaut", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnim2 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tubinaut", d.DevicePanel, 8, -1, fliph, flipv, false);
            var editorAnim3 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tubinaut", d.DevicePanel, 1, 0, fliph, flipv, false);
            var editorAnim4 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tubinaut", d.DevicePanel, 2, 8, fliph, flipv, false);
            var editorAnim5 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tubinaut", d.DevicePanel, 3, 12, fliph, flipv, false);
            var editorAnim6 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tubinaut", d.DevicePanel, 0, 1, fliph, flipv, false);
            if (editorAnim != null && editorAnim.Frames.Count != 0 && editorAnim2 != null && editorAnim2.Frames.Count != 0 && editorAnim3 != null && editorAnim3.Frames.Count != 0 && editorAnim4 != null && editorAnim4.Frames.Count != 0 && editorAnim5 != null && editorAnim5.Frames.Count != 0 && editorAnim6 != null && editorAnim6.Frames.Count != 0)
            {
                ...
                if (Interfaces.Base.MainEditor.Instance.EditorToolbar.ShowAnimations.IsChecked.Value == true && Classes.Editor.SolutionState.AllowSpriteAnimations)
                {
