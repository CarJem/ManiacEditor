...
namespace ManiacEditor.Entity_Renders
{
    public class CaterkillerJr : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Editor.Instance.EntityDrawing.LoadAnimation2("CaterkillerJr", d.DevicePanel, 0, -1, true, flipv, false);
            var editorAnim2 = Editor.Instance.EntityDrawing.LoadAnimation2("CaterkillerJr", d.DevicePanel, 1, -1, fliph, flipv, false);
            var editorAnim3 = Editor.Instance.EntityDrawing.LoadAnimation2("CaterkillerJr", d.DevicePanel, 2, -1, fliph, flipv, false);
            var editorAnim4 = Editor.Instance.EntityDrawing.LoadAnimation2("CaterkillerJr", d.DevicePanel, 3, -1, fliph, flipv, false);
