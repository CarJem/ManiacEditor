...
namespace ManiacEditor.Entity_Renders
{
    public class FlameSpring : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = Editor.Instance.EntityDrawing.LoadAnimation2("FlameSpring", d, 0, animID, fliph, flipv, false);
            var nozzelA = Editor.Instance.EntityDrawing.LoadAnimation2("FlameSpring", d, 1, 0, fliph, flipv, false);
            var nozzelB = Editor.Instance.EntityDrawing.LoadAnimation2("FlameSpring", d, 1, 1, fliph, flipv, false);
