...
namespace ManiacEditor.Entity_Renders
{
    public class MeterDroid : EntityRenderer
    {
        ...
        {
            var editorAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("MeterDroid", d, 1, -1, false, false, false);
            var editorAnim2 = e.EditorInstance.EntityDrawing.LoadAnimation2("MeterDroid", d, 8, -1, false, false, false);
