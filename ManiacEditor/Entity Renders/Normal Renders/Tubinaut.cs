...
namespace ManiacEditor.Entity_Renders
{
    public class Tubinaut : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            bool fliph = false;
            bool flipv = false;
            var editorAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("Tubinaut", d, 0, 0, fliph, flipv, false);
            var editorAnim2 = e.EditorInstance.EntityDrawing.LoadAnimation2("Tubinaut", d, 8, -1, fliph, flipv, false);
            var editorAnim3 = e.EditorInstance.EntityDrawing.LoadAnimation2("Tubinaut", d, 1, 0, fliph, flipv, false);
            var editorAnim4 = e.EditorInstance.EntityDrawing.LoadAnimation2("Tubinaut", d, 2, 8, fliph, flipv, false);
            var editorAnim5 = e.EditorInstance.EntityDrawing.LoadAnimation2("Tubinaut", d, 3, 12, fliph, flipv, false);
            var editorAnim6 = e.EditorInstance.EntityDrawing.LoadAnimation2("Tubinaut", d, 0, 1, fliph, flipv, false);
            if (editorAnim != null && editorAnim.Frames.Count != 0 && editorAnim2 != null && editorAnim2.Frames.Count != 0 && editorAnim3 != null && editorAnim3.Frames.Count != 0 && editorAnim4 != null && editorAnim4.Frames.Count != 0 && editorAnim5 != null && editorAnim5.Frames.Count != 0 && editorAnim6 != null && editorAnim6.Frames.Count != 0)
            {
                ...
                if (e.EditorInstance.ShowAnimations.IsChecked.Value == true && e.EditorInstance.UIModes.AnnimationsChecked)
                {
