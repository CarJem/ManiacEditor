...
namespace ManiacEditor.Entity_Renders
{
    public class AIZEggRobo : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityRenderProp properties)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("AIZEggRobo", d.DevicePanel, 0, -1, fliph, flipv, false);
            var editorAnimArms = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("AIZEggRobo", d.DevicePanel, 1, -1, fliph, flipv, false);
            var editorAnimLegs = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("AIZEggRobo", d.DevicePanel, 2, -1, fliph, flipv, false);
