...
namespace ManiacEditor.Entity_Renders
{
    public class SchrodingersCapsule : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Edit.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Editor.Instance.EntityDrawing.LoadAnimation2("SchrodingersCapsule", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnimInside = Editor.Instance.EntityDrawing.LoadAnimation2("SchrodingersCapsule", d.DevicePanel, 0, 2, fliph, flipv, false);
            var editorAnimExclamation = Editor.Instance.EntityDrawing.LoadAnimation2("SchrodingersCapsule", d.DevicePanel, 0, 3, fliph, flipv, false);
            var editorAnimButton = Editor.Instance.EntityDrawing.LoadAnimation2("SchrodingersCapsule", d.DevicePanel, 1, -1, fliph, flipv, false);
            ...
            if (editorAnim != null && editorAnim.Frames.Count != 0 && editorAnimButton != null && editorAnimButton.Frames.Count != 0 && editorAnimInside != null && editorAnimInside.Frames.Count != 0 && editorAnimExclamation != null && editorAnimExclamation.Frames.Count != 0)
            {
                ...
                var mightyAnim = Editor.Instance.EntityDrawing.LoadAnimation2("SchrodingersCapsule", d.DevicePanel, 3, -1, fliph, flipv, false);
                var rayAnim = Editor.Instance.EntityDrawing.LoadAnimation2("SchrodingersCapsule", d.DevicePanel, 4, -1, fliph, flipv, false);
                ...
                var editorAnimGlass = Editor.Instance.EntityDrawing.LoadAnimation2("SchrodingersCapsule", d.DevicePanel, 2, -1, fliph, flipv, false);
