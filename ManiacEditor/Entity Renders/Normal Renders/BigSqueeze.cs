...
namespace ManiacEditor.Entity_Renders
{
    public class BigSqueeze : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 0, -1, fliph, flipv, false);
            var editorAnim2 = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 0, -1, true, flipv, false);
            var editorAnim3 = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 1, -1, fliph, flipv, false);
            var editorAnim4 = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 2, -1, fliph, flipv, false);
            var editorAnim5 = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 3, -1, fliph, flipv, false);
            var editorAnim6 = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 4, -1, fliph, flipv, false);
            var editorAnim7 = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 4, -1, true, flipv, false);
            var editorAnim8 = e.EditorInstance.EntityDrawing.LoadAnimation2("BigSqueeze", d, 5, -1, true, flipv, false);
            var editorAnim9 = e.EditorInstance.EntityDrawing.LoadAnimation2("EditorIcons2", d, 0, 14, fliph, flipv, false);
