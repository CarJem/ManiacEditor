...
namespace ManiacEditor.Entity_Renders
{
    public class UIText : EntityRenderer
    {
        ...
        public void DrawEditorHUDText(Interfaces.Base.MapEditor instance, DevicePanel d, int x, int y, string text, bool highlighted, int Transparency = 0xff, int highlightDistance = -1, int highlightStart = 0)
        {
            /*
