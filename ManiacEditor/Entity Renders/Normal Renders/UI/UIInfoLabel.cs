...
namespace ManiacEditor.Entity_Renders
{
    public class UIInfoLabel : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityRenderProp properties)
        {
            ...
            {
                int frameID = GetFrameID(symb, Methods.Editor.SolutionState.MenuChar_Small);
                ...
                if (editorAnim != null && editorAnim.Frames.Count != 0)
                {
                    ...
                    d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(frame), x2 + frame.Frame.PivotX + spacingAmount, y + frame.Frame.PivotY,
