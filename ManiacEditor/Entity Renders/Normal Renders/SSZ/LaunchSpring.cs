...
namespace ManiacEditor.Entity_Renders
{
    public class LaunchSpring : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("LaunchSpring", d.DevicePanel, 0, -1, false, true, false, rotation, true, false, EditorEntityDrawing.Flag.FullEngineRotation);
            var editorAnim2 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("LaunchSpring", d.DevicePanel, 0, -1, true, true, false, rotation, true, false, EditorEntityDrawing.Flag.FullEngineRotation);
            var editorAnim3 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("LaunchSpring", d.DevicePanel, 1, -1, false, false, false);
            var editorAnim4 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("LaunchSpring", d.DevicePanel, 2, -1, false, false, false, rotation, true, false, EditorEntityDrawing.Flag.FullEngineRotation);
