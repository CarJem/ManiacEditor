...
namespace ManiacEditor.Entity_Renders
{
    public class PullSwitch : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityRenderProp properties)
        {
            ...
            var editorAnim = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("Valve", d.DevicePanel, 4, 0, fliph, flipv, false);
            var editorAnim2 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("Valve", d.DevicePanel, 4, 2, fliph, flipv, false);
