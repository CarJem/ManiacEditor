...
namespace ManiacEditor.Entity_Renders
{
    public class SpikeFlail : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("SpikeFlail", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnimBall = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("SpikeFlail", d.DevicePanel, 1, 0, fliph, flipv, false);
            var editorAnimRing1 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("SpikeFlail", d.DevicePanel, 2, 0, fliph, flipv, false);
            var editorAnimRing2 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("SpikeFlail", d.DevicePanel, 3, 0, fliph, flipv, false);
            var editorAnimRing3 = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("SpikeFlail", d.DevicePanel, 4, 0, fliph, flipv, false);
