...
namespace ManiacEditor.Entity_Renders
{
    public class HangConveyor : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("HangConveyor", d.DevicePanel, 0, -1, fliph, false, false);
            var editorAnimEnd = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("HangConveyor", d.DevicePanel, 1, -1, !fliph, false, false);
            var editorAnimMid = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("HangConveyor", d.DevicePanel, 2, -1, fliph, false, false);
            var editorAnimMid2 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("HangConveyor", d.DevicePanel, 2, -1, !fliph, false, false);
