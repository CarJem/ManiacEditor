...
namespace ManiacEditor.Entity_Renders
{
    public class Armadiloid : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("Armadiloid", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnimHead = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("Armadiloid", d.DevicePanel, 1, 0, fliph, flipv, false);
            var editorAnimBoost = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("Armadiloid", d.DevicePanel, 3, -1, fliph, flipv, false);
            var editorAnimRider = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("Armadiloid", d.DevicePanel, 4, -1, fliph, flipv, false);
