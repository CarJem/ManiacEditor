...
namespace ManiacEditor.Entity_Renders
{
    public class HotaruHiWatt : EntityRenderer
    {
        ...
        {
            var editorAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("HotaruHiWatt", d, 0, -1, false, false, false);
            var editorAnimBulb = e.EditorInstance.EntityDrawing.LoadAnimation2("HotaruHiWatt", d, 1, -1, false, false, false);
