...
namespace ManiacEditor.Entity_Renders
{
    public class TurboSpiker : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = Editor.Instance.EntityDrawing.LoadAnimation2("TurboSpiker", d.DevicePanel, 0, -1, fliph, flipv, false);
            var editorAnimShell = Editor.Instance.EntityDrawing.LoadAnimation2("TurboSpiker", d.DevicePanel, 3, 0, fliph, flipv, false);
