...
namespace ManiacEditor.Entity_Renders
{
    public class EncoreRoute : EntityRenderer
    {
        ...
        public void DrawTileGroup(GraphicsHandler d, int x, int y, int x2, int y2, int height, int width, int Transperncy, SceneEntity entity, Controls.Base.MainEditor EditorInstance)
        {
        ...
        public void DrawTile(GraphicsHandler d, ushort tile, int x, int y, bool selected, int Transperncy, Controls.Base.MainEditor EditorInstance)
        {
