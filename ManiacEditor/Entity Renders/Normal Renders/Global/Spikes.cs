...
namespace ManiacEditor.Entity_Renders
{
    public class Spikes : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            int count2 = count >> 2;
            var editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("Spikes", d.DevicePanel, animID, 0, fliph, flipv, false);
            if (isFBZ)
            {
                editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("Spikes", d.DevicePanel, animID, -1, fliph, flipv, false);
            }
        ...
        {
            var editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("Spikes", d.DevicePanel, 0, 0, false, false, false);
            if (editorAnim != null && editorAnim.Frames.Count != 0)
            {
                var frame = editorAnim.Frames[0];
