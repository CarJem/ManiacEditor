...
namespace ManiacEditor.Entity_Renders
{
    public class Tornado : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityLoadOptions properties)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Controls.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tornado", d.DevicePanel, 0, 0, fliph, flipv, false);
            var editorAnim2 = Controls.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tornado", d.DevicePanel, 1, -1, fliph, flipv, false);
            var editorAnim3 = Controls.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tornado", d.DevicePanel, 2, -1, fliph, flipv, false);
