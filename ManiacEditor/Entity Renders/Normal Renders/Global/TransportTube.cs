...
namespace ManiacEditor.Entity_Renders
{
    public class TransportTube : EntityRenderer
    {
		...
		public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
		{
			...
			var editorAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTube", d.DevicePanel, 0, 0, false, false, false);
			var upAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 0, false, false, false);
			var downAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 1, false, false, false);
			var rightAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 2, false, false, false);
			var leftAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 3, false, false, false);
			var upleftAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 4, false, false, false);
			var downleftAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 5, false, false, false);
			var uprightAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 6, false, false, false);
			var downrightAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 0, 7, false, false, false);
			var centerAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 1, false, false, false);
			var A_Anim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 2, false, false, false);
			var B_Anim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 3, false, false, false);
			var C_Anim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 4, false, false, false);
			var inOutAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 5, false, false, false);
			var junctionAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 7, false, false, false);
			var runAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 6, false, false, false);
			var unknownAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 8, false, false, false);
			var unsafeAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 0, false, false, false);
			var notValidAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TransportTubes", d.DevicePanel, 1, 9, false, false, false);
