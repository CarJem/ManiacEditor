...
namespace ManiacEditor.Entity_Renders
{
    public class Platform : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var platformIcon = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("EditorIcons2", d.DevicePanel, 0, 20, false, false, false);
            ...
            while (true)
            {
                try
                {
                    ...
                    editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation("Platform", d.DevicePanel, aminID, -1, false, false, false, 0);
                    if (type == 4) editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation("Platform", d.DevicePanel, 1, 0, false, false, false, 0);
                    if (editorAnim == null)
                    {
            ...
            var tensionBall = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation("Platform", d.DevicePanel, aminID, frameID + 1, false, false, false, 0);
            var tensionBallCenter = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation("Platform", d.DevicePanel, aminID, frameID + 2, false, false, false, 0);
            if (type == 4) tensionBall = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation("Platform", d.DevicePanel, 1, 1, false, false, false, 0);
            if (type == 4) tensionBallCenter = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation("Platform", d.DevicePanel, 1, 2, false, false, false, 0);
