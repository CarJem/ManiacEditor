...
namespace ManiacEditor.Entity_Renders
{
    public class TilePlatform : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            if (Classes.Edit.Scene.EditorSolution.CurrentScene?.Move != null)
            {
                SceneLayer Move = Classes.Edit.Scene.EditorSolution.CurrentScene?.Move.Layer;
        ...
        public void DrawTile(GraphicsHandler d, ushort tile, int x, int y, bool selected, int Transperncy)
        {
            ...
            d.DrawBitmap(Classes.Edit.Scene.EditorSolution.CurrentTiles.StageTiles.Image.GetTexture(d.DevicePanel._device, new Rectangle(0, (tile & 0x3ff) * EditorConstants.TILE_SIZE, EditorConstants.TILE_SIZE, EditorConstants.TILE_SIZE), flipX, flipY),
