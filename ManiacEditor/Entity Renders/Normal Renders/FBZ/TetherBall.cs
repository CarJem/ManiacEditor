...
namespace ManiacEditor.Entity_Renders
{
    public class TetherBall : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityRenderProp properties)
        {
            ...
            var editorAnim = Controls.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TetherBall", d.DevicePanel, 0, animID, fliph, flipv, false);
            var editorAnim2 = Controls.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TetherBall", d.DevicePanel, 0, 2, fliph, flipv, false);
            var editorAnim3 = Controls.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("TetherBall", d.DevicePanel, 0, 3, fliph, flipv, false);
