...
namespace ManiacEditor.Entity_Renders
{
    public class BigSqueeze : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, Classes.Editor.Scene.Sets.EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 0, -1, fliph, flipv, false);
            var editorAnim2 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 0, -1, true, flipv, false);
            var editorAnim3 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 1, -1, fliph, flipv, false);
            var editorAnim4 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 2, -1, fliph, flipv, false);
            var editorAnim5 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 3, -1, fliph, flipv, false);
            var editorAnim6 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 4, -1, fliph, flipv, false);
            var editorAnim7 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 4, -1, true, flipv, false);
            var editorAnim8 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("BigSqueeze", d.DevicePanel, 5, -1, true, flipv, false);
            var editorAnim9 = Interfaces.Base.MainEditor.Instance.EntityDrawing.LoadAnimation2("EditorIcons2", d.DevicePanel, 0, 14, fliph, flipv, false);
