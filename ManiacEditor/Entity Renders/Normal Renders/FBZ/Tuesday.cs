...
namespace ManiacEditor.Entity_Renders
{
    public class Tuesday : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityRenderProp properties)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tuesday", d.DevicePanel, 0, -1, fliph, flipv, false);
            var editorAnim2 = Controls.Editor.MainEditor.Instance.EntityDrawing.LoadAnimation2("Tuesday", d.DevicePanel, 2, -1, fliph, flipv, false);
