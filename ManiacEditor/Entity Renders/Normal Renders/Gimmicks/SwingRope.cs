...
namespace ManiacEditor.Entity_Renders
{
    public class SwingRope : EntityRenderer
    {
        ...
        public override void Draw(Structures.EntityRenderProp Properties)
        {
            ...
            var Animation = Methods.Draw.ObjectDrawing.LoadAnimation(Properties.Graphics, "SwingRope", 0, 0);
            ...
            Animation = Methods.Draw.ObjectDrawing.LoadAnimation(Properties.Graphics, "SwingRope", 2, 0);
            DrawTexturePivotNormal(d, Animation, Animation.RequestedAnimID, Animation.RequestedFrameID, x, y, Transparency, fliph, flipv);
            Animation = Methods.Draw.ObjectDrawing.LoadAnimation(Properties.Graphics, "SwingRope", 1, 0);
