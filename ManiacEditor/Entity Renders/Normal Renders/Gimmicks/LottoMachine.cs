...
frame13.Frame.Width, frame13.Frame.Height, false, Transparency);
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(ballslot1),
                ...
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(ballslot2),
                ...
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(ballslot3),
...
ballslot3.Frame.Width, ballslot3.Frame.Height, false, Transparency);
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(ballslot1_2),
...
ballslot1_2.Frame.Width, ballslot1_2.Frame.Height, false, Transparency);
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(ballslot2_2),
                ...
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(ballslot3_2),
...
ballslot3_2.Frame.Width, ballslot3_2.Frame.Height, false, Transparency);
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(galloplogo),
                ...
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(chute),
...
chute.Frame.Width, chute.Frame.Height, false, Transparency);
                d.DrawBitmap(new Methods.Draw.GraphicsHandler.GraphicsInfo(dispenser),
