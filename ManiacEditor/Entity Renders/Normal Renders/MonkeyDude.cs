...
namespace ManiacEditor.Entity_Renders
{
    public class MonkeyDude : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Editor.Instance.EntityDrawing.LoadAnimation2("MonkeyDude", d, 0, -1, fliph, flipv, false);
            var editorAnimTail = Editor.Instance.EntityDrawing.LoadAnimation2("MonkeyDude", d, 1, -1, fliph, flipv, false);
            var editorAnimArm = Editor.Instance.EntityDrawing.LoadAnimation2("MonkeyDude", d, 2, -1, fliph, flipv, false);
            var editorAnimHand = Editor.Instance.EntityDrawing.LoadAnimation2("MonkeyDude", d, 3, -1, fliph, flipv, false);
            var editorAnimCoconut = Editor.Instance.EntityDrawing.LoadAnimation2("MonkeyDude", d, 4, -1, fliph, flipv, false);
