...
namespace ManiacEditor.Entity_Renders
{
    public class TransportTube : EntityRenderer
    {
		...
		public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
		{
			...
			var editorAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTube", d, 0, 0, false, false, false);
			var upAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 0, false, false, false);
			var downAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 1, false, false, false);
			var rightAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 2, false, false, false);
			var leftAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 3, false, false, false);
			var upleftAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 4, false, false, false);
			var downleftAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 5, false, false, false);
			var uprightAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 6, false, false, false);
			var downrightAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 0, 7, false, false, false);
			var centerAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 1, false, false, false);
			var A_Anim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 2, false, false, false);
			var B_Anim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 3, false, false, false);
			var C_Anim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 4, false, false, false);
			var inOutAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 5, false, false, false);
			var junctionAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 7, false, false, false);
			var runAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 6, false, false, false);
			var unknownAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 8, false, false, false);
			var unsafeAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 0, false, false, false);
			var notValidAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("TransportTubes", d, 1, 9, false, false, false);
