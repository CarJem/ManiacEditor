...
namespace ManiacEditor.Entity_Renders
{
    public class LRZConvDropper : EntityRenderer
    {
        ...
        public override void Draw(GraphicsHandler d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var width = (int)(entity.attributesMap["detectSize"].ValueVector3.X.High - 1) / 16;
            var height = (int)(entity.attributesMap["detectSize"].ValueVector3.Y.High - 1) / 16;
            var offsetX = (int)(entity.attributesMap["detectOffset"].ValueVector3.X.High - 1) / 16;
            var offsetY = (int)(entity.attributesMap["detectOffset"].ValueVector3.Y.High - 1) / 16;
        ...
        {
            var widthPixels = (int)(entity.attributesMap["detectSize"].ValueVector3.X.High - 1) / 16;
            var heightPixels = (int)(entity.attributesMap["detectSize"].ValueVector3.Y.High - 1) / 16;
            var offsetX = (int)(entity.attributesMap["detectOffset"].ValueVector3.X.High - 1) / 16;
            var offsetY = (int)(entity.attributesMap["detectOffset"].ValueVector3.Y.High - 1) / 16;
