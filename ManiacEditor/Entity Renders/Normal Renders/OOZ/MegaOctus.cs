...
namespace ManiacEditor.Entity_Renders
{
    public class MegaOctus : EntityRenderer
    {
        ...
        {
            var editorAnim = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("MegaOctus", d.DevicePanel, 0, 0, false, false, false);
            var editorAnimEye = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("MegaOctus", d.DevicePanel, 0, 1, false, false, false);
            var editorAnimPupil = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("MegaOctus", d.DevicePanel, 0, 2, false, false, false);
            var editorAnimHeadJoint = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("MegaOctus", d.DevicePanel, 0, 6, false, false, false);
            var editorAnimNose = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("MegaOctus", d.DevicePanel, 1, 0, false, false, false);
            var editorAnimBolt = Interfaces.Base.MapEditor.Instance.EntityDrawing.LoadAnimation2("MegaOctus", d.DevicePanel, 2, 0, false, false, false);
