...
namespace ManiacEditor.Entity_Renders
{
    public class EggLoco : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            bool fliph = false;
            bool flipv = false;
            var editorAnim = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 0, -1, fliph, flipv, false);
            var editorAnim2 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 1, -1, fliph, flipv, false);
            var editorAnim3 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 2, -1, fliph, flipv, false);
            var editorAnim4 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 5, 0, false, false, false);
            var editorAnim5 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 7, -1, fliph, flipv, false);
            var editorAnim6 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 6, 0, false, false, false);
            var editorAnim7 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 3, -1, fliph, flipv, false);
            var editorAnim8 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 4, -1, fliph, flipv, false);
            var editorAnim9 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 10, -1, fliph, flipv, false);
            var editorAnim10 = Editor.Instance.EntityDrawing.LoadAnimation2("Train", d, 12, 0, fliph, flipv, false);
