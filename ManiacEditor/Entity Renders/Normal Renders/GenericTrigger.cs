...
namespace ManiacEditor.Entity_Renders
{
    public class GenericTrigger : EntityRenderer
    {
        ...
        {
            var widthPixels = (int)(entity.attributesMap["size"].ValueVector3.X.High) * 2;
            var heightPixels = (int)(entity.attributesMap["size"].ValueVector3.Y.High) * 2;
            var width = (int)widthPixels / 16;
            var height = (int)heightPixels / 16;

            //Draw Icon
            var editorAnim = Editor.Instance.EntityDrawing.LoadAnimation2("EditorIcons2", d.DevicePanel, 0, 5, false, false, false);
