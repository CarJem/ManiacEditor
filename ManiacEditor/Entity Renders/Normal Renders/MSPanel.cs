...
namespace ManiacEditor.Entity_Renders
{
    public class MSPanel : EntityRenderer
    {
        ...
        {
            var editorAnim = e.EditorInstance.EntityDrawing.LoadAnimation2("MSPanel", d, 0, 0, false, false, false);
            var editorAnimPanel = e.EditorInstance.EntityDrawing.LoadAnimation2("MSPanel", d, 1, -1, false, false, false);
