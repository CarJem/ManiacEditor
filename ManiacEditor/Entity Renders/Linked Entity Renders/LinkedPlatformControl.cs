    ...
    public class LinkedPlatformControl : LinkedRenderer
    {
        public override void Draw(GraphicsHandler d, RSDKv5.SceneEntity currentEntity, EditorEntity ObjectInstance)
        {
            ...
            for (int i = 0; i < ChildCount; i++)
            {
                ...
                var target1 = Classes.Editor.Solution.Entities.Entities.Where(e => e.Entity.SlotID == targetID).First();
            ...
            var tagged = Classes.Editor.Solution.Entities.Entities.Where(e => e.Entity.AttributeExists("tag", RSDKv5.AttributeTypes.UINT8));
