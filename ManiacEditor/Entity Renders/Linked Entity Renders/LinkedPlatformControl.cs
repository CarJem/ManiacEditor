        ...
        public override void Draw(GraphicsHandler d, RSDKv5.SceneEntity currentEntity, EditorEntity ObjectInstance)
        {
            ...
            for (int i = 0; i < NodeCount; i++)
            {
                ...
                if (targetID2 >= maximumSlot)
                {
                    ...
                    var target1 = Editor.Instance.Entities.Entities.Where(e => e.Entity.SlotID == targetID1).First();
                    var target2 = Editor.Instance.Entities.Entities.Where(e => e.Entity.SlotID == targetID2).First();
            ...
            for (int i = 0; i < ChildCount; i++)
            {
                ...
                var target1 = Editor.Instance.Entities.Entities.Where(e => e.Entity.SlotID == targetID).First();
            ...
            var tagged = Editor.Instance.Entities.Entities.Where(e => e.Entity.AttributeExists("tag", RSDKv5.AttributeTypes.UINT8));
