...
namespace ManiacEditor.Entity_Renders
{
    public class CaterkillerJr : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = EditorEntity_ini.LoadAnimation2("CaterkillerJr", d, 0, -1, true, flipv, false);
            var editorAnim2 = EditorEntity_ini.LoadAnimation2("CaterkillerJr", d, 1, -1, fliph, flipv, false);
            var editorAnim3 = EditorEntity_ini.LoadAnimation2("CaterkillerJr", d, 2, -1, fliph, flipv, false);
            var editorAnim4 = EditorEntity_ini.LoadAnimation2("CaterkillerJr", d, 3, -1, fliph, flipv, false);
