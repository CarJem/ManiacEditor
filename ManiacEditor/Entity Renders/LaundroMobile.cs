...
namespace ManiacEditor.Entity_Renders
{
    public class LaundroMobile : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 0, 0, fliph, flipv, false);
            var editorAnim2 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 9, blockID, fliph, flipv, false);
            var editorAnim3 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 1, -1, fliph, flipv, false);
            var editorAnim4 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 3, -1, fliph, flipv, false);
            var editorAnim5 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 8, -1, fliph, flipv, false);
            var editorAnim6 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 2, -1, fliph, flipv, false);
            var editorAnim7 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 0, 3, fliph, flipv, false);
            var editorAnim8 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 0, 2, fliph, flipv, false);
            var editorAnim9 = EditorEntity_ini.LoadAnimation2("LaundroMobile", d, 0, 4, fliph, flipv, false);
            var editorAnimIcon = EditorEntity_ini.LoadAnimation2("EditorIcons2", d, 0, 14, false, false, false);
