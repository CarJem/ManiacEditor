...
namespace ManiacEditor.Entity_Renders
{
    public class UIButtonPrompt : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnim = EditorEntity_ini.LoadAnimation("Buttons", d, Editor.Instance.CurrentControllerButtons, buttonID, false, false, false);
            var editorAnim2 = EditorEntity_ini.LoadAnimation("Buttons", d, 0, 0, false, false, false);
            var editorAnimButton = EditorEntity_ini.LoadAnimation(text, d, 0, promptID, false, false, false);
