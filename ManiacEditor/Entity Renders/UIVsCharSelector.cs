...
namespace ManiacEditor.Entity_Renders
{
    public class UIVsCharSelector : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            var editorAnimWaiting = EditorEntity_ini.LoadAnimation(text, d, 12, 7, false, false, false);
            var editorAnimBackground = EditorEntity_ini.LoadAnimation("SaveSelect", d, 14, 7, false, false, false);
            var editorAnimPlayerText = EditorEntity_ini.LoadAnimation(text, d, 12, player, false, false, false);
            var editorAnimFrame = EditorEntity_ini.LoadAnimation("EditorUIRender", d, 1, 0, false, false, false);
