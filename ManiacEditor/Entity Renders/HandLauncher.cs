        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            if (editorAnim != null && editorAnim.Frames.Count != 0 && editorAnimHand != null && editorAnimHand.Frames.Count != 0)
            {
                ...
                d.DrawBitmap(frameHand.Texture,
                    x + frameHand.Frame.CenterX - (fliph ? (frameHand.Frame.Width - editorAnimHand.Frames[0].Frame.Width) : 0),
                    y + frameHand.Frame.CenterY + (flipv ? (frameHand.Frame.Height - editorAnimHand.Frames[0].Frame.Height) : 0),
