...
namespace ManiacEditor.Entity_Renders
{
    public class PopcornMachine : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency, int index = 0, int previousChildCount = 0, int platformAngle = 0, EditorAnimations Animation = null, bool selected = false, AttributeValidater attribMap = null)
        {
            ...
            bool fliph = false;
            bool flipv = false;
            var editorAnim = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 0, fliph, flipv, false);
            var editorAnim2 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 1, fliph, flipv, false);
            var editorAnim3 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 2, false, false, false);
            var editorAnim4 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 3, false, false, false);
            var editorAnim5 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 6, false, false, false);
            var editorAnim6 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 7, false, false, false);
            var editorAnim7 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 4, false, false, false);
            var editorAnim8 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 5, false, false, false);
            var editorAnim9 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 9, false, false, false);
            var editorAnim10 = EditorEntity_ini.LoadAnimation2("PopcornMachine", d, 0, 10, false, false, false);
