...
namespace ManiacEditor.Entity_Renders
{
    public class GiantPistol : EntityRenderer
    {
        ...
        public override void Draw(DevicePanel d, SceneEntity entity, EditorEntity e, int x, int y, int Transparency)
        {
            ...
            var editorAnim = e.LoadAnimation2("Pistol", d, 0, 0, fliph, flipv, false);
            var editorAnim2 = e.LoadAnimation2("Pistol", d, 0, 1, fliph, flipv, false);
            var editorAnim3 = e.LoadAnimation2("Pistol", d, 4, 0, fliph, flipv, false);
            var editorAnim4 = e.LoadAnimation2("Pistol", d, 5, 0, fliph, flipv, false);
            var editorAnim5 = e.LoadAnimation2("Pistol", d, 6, 0, fliph, flipv, false);
